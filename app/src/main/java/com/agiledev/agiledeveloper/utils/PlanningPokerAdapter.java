...
public class PlanningPokerAdapter extends ArrayAdapter<UserStory> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final EstimateAdapter adapter = new EstimateAdapter(getContext(), story.getPlanningPokerEstimates());
        ...
        submitEstimateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                service.create(thisAdapter, story, estimate);
                estimateCreateView.setVisibility(View.GONE);
                estimatesListView.setVisibility(View.VISIBLE);
            }
        });
