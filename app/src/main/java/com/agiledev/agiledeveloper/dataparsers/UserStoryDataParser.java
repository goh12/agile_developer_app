...
public class UserStoryDataParser {
    ...
    public UserStory JSONtoUS(JSONObject userStoryJSON){
        try{
            // Set variables
            UserStory us = new UserStory(userStoryJSON.getString("id");
            us.setAuthor(userStoryJSON.getString("author"));
            us.setTextContent(userStoryJSON.getString("textContent"));
            us.setPriority(userStoryJSON.getString("priority"));
            us.setPlanningPokerPriority(userStoryJSON.getString("planningPokerPriority"));
